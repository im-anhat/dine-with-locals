    ...
    return (
      <DrawerContent className="max-h-[85vh]">
        <DrawerHeader className="border-b">
          <DrawerTitle>Experience Details</DrawerTitle>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Badge
              variant={listing.status === 'waiting' ? 'secondary' : 'default'}
            >
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="ml-6 space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {listing.locationId.city}, {listing.locationId.state}{' '}
                    {listing.locationId.zipCode}
                  </p>
                  <p className="text-xs text-muted-foreground">
                    {listing.locationId.country}
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="ml-6">
                  <p className="text-sm">
                    {listing.numGuests}{' '}
                    {listing.numGuests === 1 ? 'guest' : 'guests'}
                  </p>
                </div>
              </div>
            </CardContent>
