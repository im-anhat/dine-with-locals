...
export const getAllBlogs = async (req, res) => {
    try {
        const blogs = await Blog.find().populate('userId', 'userName firstName lastName avatar');
...
export const getBlogById = async (req, res) => {
    try {
        ...
        const blog = await Blog.findById(id).populate('userId', 'userName firstName lastName avatar');
        if (!blog) {
