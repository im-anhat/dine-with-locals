...
describe('Location Model Tests', () => {
    ...
    describe('Location Creation', () => {
        it('should create a new location with valid data', async () => {
            ...
            expect(savedLocation.coordinates.lat).toBe(validLocationData.coordinates.lat);
            expect(savedLocation.coordinates.lng).toBe(validLocationData.coordinates.lng);
