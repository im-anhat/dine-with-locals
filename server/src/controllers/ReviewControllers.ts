// filepath: /Users/nhatle/Documents/vtmp/dine-with-locals/server/src/controllers/ReviewControllers.ts
...
export const getReviewsByUserId: RequestHandler = async (
  req: Request,
  res: Response,
) => {
  try {
...
export const getReviewsByReviewerId: RequestHandler = async (
  req: Request,
  res: Response,
) => {
  try {
