...
async function seed() {
  try {
    ...
    const request1 = new Request({
      ...
      numGuests: 2,
      additionalInfo:
        'Looking for a casual dinner meeting. Hoping to meet new people and enjoy local food.',
      status: 'waiting',
    });
    await request1.save();
    ...
    const blog1 = new Blog({
      ...
      blogContent:
        'I had a great dining experience hosted by im-anhat at the Spicy and Sour Pad Thai listing. The food and ambiance were exceptional!',
      photos: [
